<?php 
 ...
 <style>
  ...
  <main class="detailDestination" >
  	<?php 
  		if(!empty($tmpVariable['data']['Entertainment']['image360'])){ ?>
  			<div class="ifram_destination">
				<?php echo $tmpVariable['data']['Entertainment']['image360'] ?>
			</div>
  <?php	}
  	?>
			...
			<ul class="container">
				...
				<li><a href=""><?php echo $tmpVariable['data']['Entertainment']['name']?></a></li>
			</ul>
			<div class="detail_destination container">
				<div class="row">
					<div class="col-md-8 col-12">
						
						<h1><?php echo $tmpVariable['data']['Entertainment']['name']?></h1>
						<div class="list_cmt">
							<p><i class="far fa-heart"></i> 10</p>
							<p><i class="fas fa-share-alt"></i> 10</p>
							<p><i class="far fa-star"></i> 10</p>
						</div>
						<?php echo $tmpVariable['data']['Entertainment']['content']?>
					...
					<div class="col-md-4 col-12">
						<div class="info_placeDetail">
							<p><i class="fas fa-map-marker-alt"></i> <?php echo $tmpVariable['data']['Entertainment']['address']?></p>
											...
											<div class="col-md-12  col-12 " >
												<div class="item_destination" style="background-image: url(<?php echo $value['Entertainment']['image']?>);">
													<div class="title_destination">
														<a href="/chi_tiet_di_tich_lich_su/<?php echo $value['Entertainment']['urlSlug'] ?>.html">
