  ...
  <?php	}
  	?>
			...
			<ul class="container">
				...
				<li><a href="">Di tích và danh lam / </a></li>
				<li><a href=""><?php echo $tmpVariable['data']['Restaurant']['name']?></a></li>
			</ul>
			<div class="detail_destination container">
				<div class="row">
					<div class="col-md-8 col-12">
						
						<h1><?php echo $tmpVariable['data']['Restaurant']['name']?></h1>
						<div class="list_cmt">
							<p><i class="far fa-heart"></i> 10</p>
							<p><i class="fas fa-share-alt"></i> 10</p>
							<p><i class="far fa-star"></i> 10</p>
						</div>
						<?php echo $tmpVariable['data']['Restaurant']['content']?>
					...
					<div class="col-md-4 col-12">
						<div class="info_placeDetail">
							<p><i class="fas fa-map-marker-alt"></i> <?php echo $tmpVariable['data']['Restaurant']['address']?></p>
							<p><i class="fas fa-clock"></i><?php echo $tmpVariable['data']['Restaurant']['timeStart'] ?>-<?php echo $tmpVariable['data']['Restaurant']['timeEnd'] ?></p>
						</div>
						<div class="list_New">
