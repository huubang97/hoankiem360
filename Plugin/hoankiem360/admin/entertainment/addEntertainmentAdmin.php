    ...
    <form action="" method="post" name="">
        <div class="taovien col-md-12 col-sm-12 col-xs-12" >
            ...
            <div class="form-group col-sm-6">
                ...
                <input type="text" name="phone" class="form-control" id="phone" value="<?php echo @$save['Entertainment']['phone'] ?>">
            </div>
            <div class="form-group col-sm-6">
                <i>Email:</i>
            ...
            <div class="form-group col-sm-6">
             ...
             <div class="form-group col-sm-6">
                <i>Seo:</i>
                <input type="text" name="seo" class="form-control" id="seo" value="<?php echo @$save['Entertainment']['seo'] ?>">
            </div>
             <div class="form-group col-sm-6">
                <i>Từ khóa metadata:</i>
                <input type="text" name="keyMetadata" class="form-control" id="keyMetadata" value="<?php echo @$save['Entertainment']['keyMetadata'] ?>">
            </div>
            <div class="form-group col-sm-6">
                <i> Mô tả thẻ metadata:</i>
                <input type="text" name="notmetadata" class="form-control" id="notmetadata" value="<?php echo @$save['Entertainment']['notmetadata'] ?>">
            </div>
             <div class="form-group col-sm-6">
                <i>Vĩ độ:</i>
             ...
             <div class="form-group col-sm-6">
                <i>Ảnh 360:</i>
                <textarea type="text" name="image360" class="form-control" id="image360"  value="<?php echo @$save['Entertainment']['image360'] ?>"></textarea>
                <br>    
                <i>Thứ tự:</i>
            ...
            <div class="form-group col-sm-6">
                <i>Tác giả:</i>
                <input type="text" name="author" class="form-control" id="author" value="<?php echo @$save['Entertainment']['author'] ?>">
            </div>
