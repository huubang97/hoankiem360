...
<div class="clear"></div>
<a style="padding: 4px 8px;" href="<?php echo $urlPlugins . 'admin/hoankiem360-admin-hotel-addHotelAdmin.php'; ?>" class="input">
...
<div class="taovien" >
    ...
    <form action="" method="post" name="listForm">
        <table id="listTable" cellspacing="0" class="tableList">
            ...
            if (!empty($listData)) {
                ...
                foreach ($listData as $item) {
                    ?>
                    <tr>
                        <td><img src="<?php echo $item['Hotel']['image']; ?>" width="100" /></td>
                        <td><?php echo $item['Hotel']['name'] ?></td>
                        <td><?php echo $item['Hotel']['phone'] ?></td>
                        <td><?php echo $item['Hotel']['address'] ?></td>
                        
                        <td align="center">
                            <a href="<?php echo $urlPlugins . 'admin/hoankiem360-admin-hotel-addHotelAdmin.php?id='.$item['Hotel']['id']; ?>">Sửa</a>
                        </td>
                        <td align="center">
                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa chương trình này không?');" href="<?php echo $urlPlugins . 'admin/hoankiem360-admin-hotel-deleteHotelAdmin.php?id='.$item['Hotel']['id']; ?>">Xóa</a>
                        </td>
        ...
        <p>
            <?php
            $urlListHotelAdmin = $urlPlugins . 'admin/hoankiem360-admin-hotel-listHotelAdmin.php';
            if ($page > 5) {
                $startPage = $page - 5;
            } else {
                $startPage = 1;
