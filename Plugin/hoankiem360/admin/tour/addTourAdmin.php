    ...
    <form action="" method="post" name="">
        <div class="taovien col-md-12 col-sm-12 col-xs-12" >
            <div class="form-group col-sm-6">
                ...
                <input type="text" maxlength="100" name="name" id="name" value="<?php echo @$save['Tour']['name'] ?>" class="form-control" required="">
            </div>
             <div class="form-group col-sm-6">
            ...
            <div class="form-group col-sm-6">
                <i>Email:</i>
                <input type="text" name="email" class="form-control" id="email"  value="<?php echo @$save['Tour']['email'] ?>">
            </div>
            <div class="form-group col-sm-6">
               <i>Ảnh đại diện</i>
                <br>
                <?php
                if (!empty($save['Tour']['image'])) {
                    $image = $save['Tour']['image'];
                } else {
                    $image = '';
                }
            ...
            <div class="form-group col-sm-6">
             ...
             <div class="form-group col-sm-6">
                <i>Vĩ độ:</i>
                <input type="text" name="latitude" class="form-control" id="latitude" value="<?php echo @$save['Tour']['latitude'] ?>">
            </div>
             <div class="form-group col-sm-6">
                <i>Kinh độ:</i>
                <input type="text" name="longitude" class="form-control" id="longitude" value="<?php echo @$save['Tour']['longitude'] ?>">
            </div>
             <div class="form-group col-sm-6">
                <i>Ảnh 360:</i>
                <textarea type="text" name="image360" class="form-control" id="image360"  value="<?php echo @$save['Tour']['image360'] ?>"></textarea>
                <br>    
                <i>Thứ tự:</i>
                <input type="text" name="cassavaorder" class="form-control" id="cassavaorder" value="<?php echo @$save['Tour']['cassavaorder'] ?>">
            </div>
            <div class="form-group col-sm-6">
                <i>Tổng quan:</i>
               <textarea name="introductory" id="introductory" onkeyup="" class="form-control" rows="5"><?php echo @$save['Tour']['introductory'] ?></textarea>
            </div>
            <div class="form-group col-sm-12">
                <i>Nội dung bài viết</i>
               <?php
                        showEditorInput('content','content',@$save['Tour']['content'],1);
                    ?>                                          
            </div>  
        </div>
