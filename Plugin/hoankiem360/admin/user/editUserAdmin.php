    ...
    <form action="" method="post" name="">
        ...
        <div class="taovien col-md-6 col-sm-12 col-xs-12" >
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control"  value="" autocomplete="off" minlength="6">
            </div>
        ...
        <div class="taovien col-md-6 col-sm-12 col-xs-12" >
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="actived">
                    <option value="1" <?php if(isset($data['User']['actived']) && $data['User']['actived']==1) echo 'selected'; ?>>Kích hoạt</option>
                    <option value="0" <?php if(isset($data['User']['actived']) && $data['User']['actived']==0) echo 'selected'; ?>>Khóa</option>
                </select>
            </div>
            <div class="form-group">
