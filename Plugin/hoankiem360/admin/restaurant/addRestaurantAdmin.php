...
<div class="taovien row">
    ...
    <form action="" method="post" name="">
        <div class="taovien col-md-12 col-sm-12 col-xs-12" >
            ...
            <div class="form-group col-sm-6">
                <i>Email:</i>
                <input type="text" name="email" class="form-control" id="email" required="" value="<?php echo @$save['Restaurant']['email'] ?>">
            </div>
            <div class="form-group col-sm-6">
            ...
            <!-- <div class="form-group col-sm-6">
                ...
                <input type="text" name="idHotel" class="form-control" id="idHotel"  value="<?php echo @$save['Restaurant']['idHotel'] ?>">
            </div> -->
